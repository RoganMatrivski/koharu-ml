use crate::core::{TextShaderEffect, TextStrokeStyle};
...
pub struct LlmLoadParams {
    pub target: crate::core::LlmTarget,
    pub options: Option<crate::core::LlmGenerationOptions>,
}
...
pub struct ProcessRequest {
    ...
    pub llm: Option<crate::core::PipelineLlmRequest>,
    pub language: Option<String>,
...
pub struct ProcessParams {
    pub document_id: Option<String>,
    pub llm_target: Option<crate::core::LlmTarget>,
    pub language: Option<String>,
    pub system_prompt: Option<String>,
    pub shader_effect: Option<String>,
}
...
mod tests {
    ...
    fn command_dtos_round_trip() {
        ...
        round_trip(&crate::core::LlmLoadRequest {
            target: crate::core::LlmTarget {
                kind: crate::core::LlmTargetKind::Local,
                model_id: "sakura".to_string(),
                provider_id: None,
            },
            options: Some(crate::core::LlmGenerationOptions {
        ...
        round_trip(&LlmLoadParams {
            target: crate::core::LlmTarget {
                kind: crate::core::LlmTargetKind::Provider,
        ...
        round_trip(&ProcessRequest {
            ...
            llm: Some(crate::core::PipelineLlmRequest {
                target: crate::core::LlmTarget {
                    kind: crate::core::LlmTargetKind::Provider,
                    model_id: "gpt-5-mini".to_string(),
                    provider_id: Some("openai".to_string()),
        ...
        round_trip(&ProcessParams {
            document_id: Some("abc123".to_string()),
            llm_target: Some(crate::core::LlmTarget {
                kind: crate::core::LlmTargetKind::Local,
                model_id: "sakura".to_string(),
                provider_id: None,
            }),
