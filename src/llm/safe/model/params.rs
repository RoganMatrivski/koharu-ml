...
use crate::llm::safe::model::params::kv_overrides::KvOverrides;
use std::ffi::{CStr, c_char};
use std::fmt::{Debug, Formatter};
use std::pin::Pin;
use std::ptr::null;

#[path = "params/kv_overrides.rs"]
pub mod kv_overrides;

#[allow(clippy::cast_possible_wrap)]
#[allow(clippy::cast_possible_truncation)]
const LLAMA_SPLIT_MODE_NONE: i8 = crate::llm::sys::LLAMA_SPLIT_MODE_NONE as i8;
#[allow(clippy::cast_possible_wrap)]
#[allow(clippy::cast_possible_truncation)]
const LLAMA_SPLIT_MODE_LAYER: i8 = crate::llm::sys::LLAMA_SPLIT_MODE_LAYER as i8;
#[allow(clippy::cast_possible_wrap)]
#[allow(clippy::cast_possible_truncation)]
const LLAMA_SPLIT_MODE_ROW: i8 = crate::llm::sys::LLAMA_SPLIT_MODE_ROW as i8;
...
pub struct LlamaModelParams {
    pub(crate) params: crate::llm::sys::llama_model_params,
    kv_overrides: Vec<crate::llm::sys::llama_model_kv_override>,
    buft_overrides: Vec<crate::llm::sys::llama_model_tensor_buft_override>,
    devices: Pin<Box<[crate::llm::sys::ggml_backend_dev_t; LLAMA_CPP_MAX_DEVICES]>>,
}
...
impl LlamaModelParams {
    ...
    pub fn append_kv_override(
        ...
        self.kv_overrides.push(crate::llm::sys::llama_model_kv_override {
            key: [0; 128],
            tag: 0,
            __bindgen_anon_1: crate::llm::sys::llama_model_kv_override__bindgen_ty_1 { val_i64: 0 },
        });
...
impl LlamaModelParams {
    ...
    pub fn add_cpu_buft_override(mut self: Pin<&mut Self>, key: &CStr) {
        ...
        buft_override.buft = unsafe { crate::llm::sys::ggml_backend_cpu_buffer_type() };
        ...
        // push the next one to ensure we maintain the iterator invariant of ending with a 0
        self.buft_overrides
            .push(crate::llm::sys::llama_model_tensor_buft_override {
...
impl LlamaModelParams {
    ...
    pub fn devices(&self) -> Vec<usize> {
        ...
        for i in 0..unsafe { crate::llm::sys::ggml_backend_dev_count() } {
            let dev = unsafe { crate::llm::sys::ggml_backend_dev_get(i) };
    ...
    pub fn with_devices(mut self, devices: &[usize]) -> Result<Self, LlamaCppError> {
        ...
        // Check device count
        let max_devices = crate::llm::safe::max_devices().min(LLAMA_CPP_MAX_DEVICES);
        if devices.len() > max_devices {
            return Err(LlamaCppError::MaxDevicesExceeded(max_devices));
        }
        for (i, &dev) in devices.iter().enumerate() {
            if dev >= unsafe { crate::llm::sys::ggml_backend_dev_count() } {
                return Err(LlamaCppError::BackendDeviceNotFound(dev));
            }
            let backend_dev = unsafe { crate::llm::sys::ggml_backend_dev_get(dev) };
...
impl Default for LlamaModelParams {
    fn default() -> Self {
        let default_params = unsafe { crate::llm::sys::llama_model_default_params() };
        LlamaModelParams {
