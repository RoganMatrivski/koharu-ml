...
impl ParamOverrideValue {
    pub(crate) fn tag(&self) -> crate::llm::sys::llama_model_kv_override_type {
        match self {
            ParamOverrideValue::Bool(_) => crate::llm::sys::LLAMA_KV_OVERRIDE_TYPE_BOOL,
            ParamOverrideValue::Float(_) => crate::llm::sys::LLAMA_KV_OVERRIDE_TYPE_FLOAT,
            ParamOverrideValue::Int(_) => crate::llm::sys::LLAMA_KV_OVERRIDE_TYPE_INT,
            ParamOverrideValue::Str(_) => crate::llm::sys::LLAMA_KV_OVERRIDE_TYPE_STR,
        }
    }

    pub(crate) fn value(&self) -> crate::llm::sys::llama_model_kv_override__bindgen_ty_1 {
        match self {
            ParamOverrideValue::Bool(value) => {
                crate::llm::sys::llama_model_kv_override__bindgen_ty_1 { val_bool: *value }
            }
            ParamOverrideValue::Float(value) => {
                crate::llm::sys::llama_model_kv_override__bindgen_ty_1 { val_f64: *value }
            }
            ParamOverrideValue::Int(value) => {
                crate::llm::sys::llama_model_kv_override__bindgen_ty_1 { val_i64: *value }
            }
            ParamOverrideValue::Str(c_string) => {
                crate::llm::sys::llama_model_kv_override__bindgen_ty_1 { val_str: *c_string }
            }
        }
    }
}

impl From<&crate::llm::sys::llama_model_kv_override> for ParamOverrideValue {
    fn from(
        crate::llm::sys::llama_model_kv_override {
            key: _,
            tag,
            __bindgen_anon_1,
        }: &crate::llm::sys::llama_model_kv_override,
